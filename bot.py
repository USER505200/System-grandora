...
async def send_rules(ctx):
    LOGO_URL = "https://cdn.discordapp.com/attachments/1488235109650796786/1495178588738293982/Comp_1.gif?ex=69f12a92&is=69efd912&hm=83176a70a6937c8b291dcb266a041efc00dfa4f3d885ca43acb64414f2773a74&"
    BANNER_URL = "https://cdn.discordapp.com/attachments/1488235109650796786/1495178589958836346/Untitled-1.gif?ex=69f12a92&is=69efd912&hm=dedca0c215b363bd42b2d8ca0ec0b998b7349d99062e5f69f99c0a2a3d0dc0ad&"

    embed = discord.Embed(
        color=0xdd7222,
        description=(
            "**We do the Grind You keep the Chill**\n\n"
            "> *The gold standard for secure, hand-played account progression.*\n\n"
            "──────────────────────────────────\n\n"
            "**⚔️ WHAT WE OFFER**\n"
            ...
            "**📜 GET STARTED**\n"
            "1. Read our **Safety Protocols** in <#1487241905833251069>.\n"
            "2. Browse our rates in <#1488969938210128134>.\n"
            "3. Open a ticket in <#1487244035516006551> to begin.\n\n"
            "> **⚠️ SECURITY ADVISORY**\n"
            "> *Grindora staff will **NEVER** DM you first or use external middlemen. Always verify roles before sending payment.*\n\n"
            "**👇 PRESS THE BUTTON BELOW TO GAIN FULL ACCESS**"
        )
    )
    ...
    embed.set_footer(text="Grindora — Premier OSRS Services", icon_url=LOGO_URL)
...
async def pay_command(ctx):
    ...
    embed.add_field(
        name="",
        value="⚔️ **OSRS GP** - Contact staff for details",
        inline=False
    )
...
async def on_interaction(interaction):
    ...
    if custom_id == "Grindora_verify":
        ...
        await interaction.response.send_message(
            f"💰 **Payment Methods**\n"
            f"Please visit <#{config.CH_RATES}> for our payment methods and rates!\n\n"
            f"You can also use the `!p` command in any channel.",
            ephemeral=True
        )
        ...
        await interaction.response.send_message(
            ...
            f"Check out <#{config.CH_RULES}> for our complete list of services!\n\n"
            f"We offer Skilling, Questing, PvM, Raids, and Elite Unlocks.",
            ephemeral=True
        )
